...
2) verify that in your MainFX in the method start that you are linking the right window file .fxml like this : <<<<< FXMLLoader loader = new FXMLLoader(getClass().getResource("/name_of_your_main_window.fxml")); >>>>
